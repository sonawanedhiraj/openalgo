...
Adopted from upstream marketcalls/openalgo on 2026-06-11. Only edit vs upstream:
path depth (parents[2] for the test/upstream/ nesting) + the pytestmark line.
"""
...
_MODULE_PATH = pathlib.Path(__file__).resolve().parents[2] / "websocket_proxy" / "mode_utils.py"
