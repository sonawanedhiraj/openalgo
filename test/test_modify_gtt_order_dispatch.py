...
def test_modify_gtt_routes_to_broker_when_live(fresh_intent_db, monkeypatch):
    ...
    monkeypatch.setattr(
        modify_gtt_order_service, "import_broker_gtt_module",
...
def test_modify_gtt_rejects_when_skip(fresh_intent_db, monkeypatch):
    from services import modify_gtt_order_service
    from services.mode_service import set_daily_intent
...
def test_modify_gtt_rejects_when_disabled(fresh_intent_db, monkeypatch):
    from services import modify_gtt_order_service
